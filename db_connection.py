...
userID: str = '29560633'#input('User ID [postgres]--> ') or "postgres"
...
password: str = 'n_9omBqS'#getpass.getpass(prompt=userID + ' password--> ')
host: str = 'CECS-Postgresql'#input('hostname [localhost]--> ') or "localhost"
port: str = '5432'#input('port number [5433]--> ') or "5433"
database: str = '2023SummerS01'#input('database [postgres]--> ') or "postgres"
