...
class StudentMajor(Base):
    ...
    major: Mapped["Major"] = relationship(back_populates="student")
    majorName: Mapped[str] = mapped_column('major_name', ForeignKey("major.name"), primary_key=True)
    student: Mapped["Student"] = relationship(back_populates="major")
